...
export const tavilySearchAgent: AgentFunction<
  TavilySearchParams,
...
> = async ({ namedInputs, params, config }) => {
  ...
  assert(
    !!query,
    "tavilySearchAgent: query is required! set inputs: { query: 'search terms' }"
  );
...
const tavilySearchAgentInfo: AgentFunctionInfo = {
  ...
  params: {
    ...
    properties: {
      ...
      include_raw_content: {
        ...
        description:
          "Include raw content from search results (boolean, markdown, text)",
      },
    },
  },
  inputs: {
        ...
        results: [
          {
            ...
            content:
              "The year 2024 has seen significant advances in artificial intelligence...",
            rawContent: null,
            score: 0.95,
          },
        ],
  ...
  description:
    "Performs web search using Tavily API and returns relevant search results with optional AI-generated answers",
  category: ["search", "web"],
  author: "Receptron Team",
  repository:
    "https://github.com/receptron/mulmocast-cli/tree/main/src/agents/tavily_agent.ts",
  source:
    "https://github.com/receptron/mulmocast-cli/tree/main/src/agents/tavily_agent.ts",
